...
new Testcase({
  ...
  testcase() {
    ...
    this.wait(1000);
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-comment", "${comment}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-avmonitor", "${avmonitor}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-http", "${http}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-smtp", "${smtp}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-pop3", "${pop3}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-imap", "${imap}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-mapi", "${mapi}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-ftp", "${ftp}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-executableAsVirus", "${executableAsVirus}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-ftgdAnalytics", "${ftgdAnalytics}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-analyticsDb", "${analyticsDb}")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-mobileMalwareDb", "${mobileMalwareDb}")`
    );
  ...
  verify() {
    ...
    this.isCheck(
      gateMap["Treat Windows Executables in Email Attachments as Viruses"],
      executableAsVirus
    );
...
new Testcase({
  ...
  testcase() {
    ...
    this.wait(1000);
    this.evaluate(
      `FcldUiTest.setUiObjectValue("utmAntiVirusEditor-comment", "")`
    );
    this.click(cloudMap["Save"]);
  },
  verify() {
