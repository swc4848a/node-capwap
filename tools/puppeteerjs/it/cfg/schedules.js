...
new Testcase({
    ...
    testcase() {
        ...
        this.set('#fcld-scheduleOnetimeEditor-name', "onetime one")
...
new Testcase({
    ...
    testcase() {
        ...
        this.evaluate(`FcldUiTest.setUiObjectValue("scheduleRecurringEditor-day", ["Sunday","Saturday"])`)
...
new Testcase({
    ...
    testcase() {
        ...
        this.wait(1000)
        this.set('#fcld-scheduleGroupEditor-name', "schedule group one")
        this.evaluate(`FcldUiTest.setUiObjectValue("scheduleGroupEditor-member", ["always"])`)
