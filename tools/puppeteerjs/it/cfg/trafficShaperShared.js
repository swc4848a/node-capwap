...
/**
 * Editor: trafficShaperSharedEditor
 * Key/Id
 *  i : name,
 *  i : perPolicy,
 *  k : priority,
 *  i : maximumBandwidth,
 *  i : guaranteedBandwidth,
 *  i : diffserv,
 *  i : diffservcode
 */
...
new Testcase({
  ...
  testcase() {
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("trafficShaperSharedEditor-priority", "${priority}")`
    );
    this.set(
      "#fcld-trafficShaperSharedEditor-maximumBandwidth",
      maximumBandwidth
    );
    this.set(
      "#fcld-trafficShaperSharedEditor-guaranteedBandwidth",
      guaranteedBandwidth
    );
