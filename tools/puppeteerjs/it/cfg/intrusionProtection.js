...
let cloudMap = {
  ...
  "3Com.Intelligent.Management.Center.Information.Disclosure":
    "div.tk-ModalDialog input:checkbox:eq(2)~label",
...
new Testcase({
  ...
  testcase() {
    ...
    this.wait(4000);
    this.click(
      cloudMap["3Com.Intelligent.Management.Center.Information.Disclosure"]
    );
  ...
  verify() {
    ...
    this.has(
      gateMap["3Com.Intelligent.Management.Center.Information.Disclosure"]
    );
  }
});
