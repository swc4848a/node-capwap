...
let gateMap = {
  ...
  "Country Dial Code Canada":
    "span.entry-value>span:contains('United States/Canada (+1)')",
...
new Testcase({
  ...
  testcase() {
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userRadiusServersEditor-authenticationMethod", "PAP")`
    );
...
new Testcase({
  ...
  testcase() {
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserEditor-type", "RADIUS User")`
    );
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserEditor-status", "false")`
    );
...
new Testcase({
  ...
  testcase() {
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-groupType", "Firewall User Group")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-member", ["guest"])`
    );
...
new Testcase({
  ...
  testcase() {
    ...
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-groupType", "Guest User Group")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-multipleGuestAdd", "false")`
    );

    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-userId", "Email")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-password", "Specify")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-expireType", "After First Login")`
    );
    this.set("#fcld-userUserGroupEditor-expire", "5");
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-expireTimeUnit", "days")`
    );
    this.set("#fcld-userUserGroupEditor-maxAccounts", "5");
    this.wait(1000);
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-userName", "true")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-sponsorEnable", "false")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-companyEnable", "false")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-email", "true")`
    );
    this.evaluate(
      `FcldUiTest.setUiObjectValue("userUserGroupEditor-mobilePhone", "false")`
    );
