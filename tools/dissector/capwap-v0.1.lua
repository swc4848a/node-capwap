...
pf.vap_flags_local_switching = ProtoField.new("VAP Flags Local Switching", "ftnt.capwap.message.element.fortinet.vap.flags.local.swtiching", ftypes.UINT32, nil, base.DEC, 0x00000001)
pf.vap_flags_local_bridging = ProtoField.new("VAP Flags Local Bridging", "ftnt.capwap.message.element.fortinet.vap.flags.local.bridging", ftypes.UINT32, nil, base.DEC, 0x00000002)
pf.vap_flags_local_mcast_enhance = ProtoField.new("VAP Flags Mcast Enhance", "ftnt.capwap.message.element.fortinet.vap.flags.mcast.enhance", ftypes.UINT32, nil, base.DEC, 0x00000004)
pf.vap_flags_local_auth = ProtoField.new("VAP Flags Local Auth", "ftnt.capwap.message.element.fortinet.vap.flags.local.auth", ftypes.UINT32, nil, base.DEC, 0x00000008)
pf.vap_flags_mesh = ProtoField.new("VAP Flags Mesh", "ftnt.capwap.message.element.fortinet.vap.flags.mesh", ftypes.UINT32, nil, base.DEC, 0x00000010)
pf.vap_flags_local_standalone = ProtoField.new("VAP Flags Local Standalone", "ftnt.capwap.message.element.fortinet.vap.flags.local.standalone", ftypes.UINT32, nil, base.DEC, 0x00000020)
pf.vap_flags_split_tunnel = ProtoField.new("VAP Flags Split Tunnel", "ftnt.capwap.message.element.fortinet.vap.flags.split.tunnel", ftypes.UINT32, nil, base.DEC, 0x00000040)
pf.vap_flags_intra_privacy = ProtoField.new("VAP Flags Intra Privacy", "ftnt.capwap.message.element.fortinet.vap.flags.split.tunnel", ftypes.UINT32, nil, base.DEC, 0x00000080)
pf.vap_flags_cpauth = ProtoField.new("VAP Flags CPAuth", "ftnt.capwap.message.element.fortinet.vap.flags.cpauth", ftypes.UINT32, nil, base.DEC, 0x00000100)
pf.vap_flags_nat_addr = ProtoField.new("VAP Flags NAT Addr", "ftnt.capwap.message.element.fortinet.vap.flags.nat.addr", ftypes.UINT32, nil, base.DEC, 0x00000200)
pf.vap_flags_lan_isolation = ProtoField.new("VAP Flags LAN Isolation", "ftnt.capwap.message.element.fortinet.vap.flags.lan.isolation", ftypes.UINT32, nil, base.DEC, 0x00000400)
...
function vapFlagsDecoder(tlv, tvbrange)
    ...
    tlv:add(pf.radio_id, tvb:range(0, 1))
    tlv:add(pf.wlan_id, tvb:range(1, 1))
    local vap_flags_tree = tlv:add("Vap Flags")
    local vap_flags = tvb:range(2, 4)
    vap_flags_tree:add(pf.vap_flags_local_switching, vap_flags)
    vap_flags_tree:add(pf.vap_flags_local_bridging, vap_flags)
    vap_flags_tree:add(pf.vap_flags_local_mcast_enhance, vap_flags)
    vap_flags_tree:add(pf.vap_flags_local_auth, vap_flags)
    vap_flags_tree:add(pf.vap_flags_mesh, vap_flags)
    vap_flags_tree:add(pf.vap_flags_local_standalone, vap_flags)
    vap_flags_tree:add(pf.vap_flags_split_tunnel, vap_flags)
    vap_flags_tree:add(pf.vap_flags_intra_privacy, vap_flags)
    vap_flags_tree:add(pf.vap_flags_cpauth, vap_flags)
    vap_flags_tree:add(pf.vap_flags_nat_addr, vap_flags)
    vap_flags_tree:add(pf.vap_flags_lan_isolation, vap_flags)
end
